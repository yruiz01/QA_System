...
if (!isset($_SESSION['nombre'])) {
    ...
    if ($_SESSION['escritorio'] == 1) {
        ...
        $rsptav = $consulta->cantidadalumnos();
                                            ...
                                            <div class="box-header with-border">
                                                ...
                                                <div class="box-tools pull-right">
                                                    <span data-toggle="tooltip" title="" class="badge" data-original-title="Cantidad de Beneficiarios">
                                                        <?php
                                                        // Actualizamos cantidadg para usar solo idgrupo
                                                        $rsptag = $consulta->cantidadg($idgrupo);
                                            ...
                                            <div class="box-body" style="">
                                                <div class="direct-chat-messages">
                                                    <div class="direct-chat-msg">
                                                        <?php
                                                        $rsptas = $consulta->cantidadalumnos_porgrupo($idgrupo);
